...
import (
	samplecontrollerv1alpha1 "batata/feijao/pkg/apis/samplecontroller/v1alpha1"
	versioned "batata/feijao/pkg/generated/clientset/versioned"
	internalinterfaces "batata/feijao/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "batata/feijao/pkg/generated/listers/samplecontroller/v1alpha1"
	"context"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TesteV1alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TesteV1alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
